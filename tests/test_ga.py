...
here is that the check asks for analyticsdata/v1beta and nothing else, since a
...
class FakeReport:
    ...
    # The Data API's own method and parameter names; a fake that renames
    # them is a fake that tests nothing.
    def runRealtimeReport(self, property, body):  # noqa: N802, A002
