...
import healthbot.helper.UtilsHelper as utils
...
def test_slack_base_url_override(monkeypatch):
    ...
    sender = SlackNotificationAware(logger=None, token="xoxb-local")
...
def test_seed_provisions_everything_the_bot_reads(monkeypatch):
    ...
    # client factory is swapped for plain moto-mocked clients here — the
