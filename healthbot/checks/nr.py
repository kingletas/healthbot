...
def get_newrelic_status(
    api_key: str | None = None, summary: str = "end_user_summary", name_filter: str | None = None
):
...
def get_newrelic_app(api_key: str | None = None, name_filter: str | None = None) -> Applications:
...
def get_new_relic_data(secrets: dict, name_filter: str | None = None) -> dict:
