...
~/Services/dev-services — one instance for the machine, not one
...
STORE_BASE = environ.get("HB_LOCAL_STORE_BASE", "http://localhost:8080")
...
# binds to — reachable from the host and from every container, and not
...
def drop_ec2_metrics_cache() -> None:
    ...
    try:
        ...
        CacheAwareHelper(db=0).delete("ec2_metrics")
